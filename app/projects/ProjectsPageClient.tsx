...
const categories = [
  ...
  { id: "barndominium", label: "Barndominium" },
    ...
    <div className="pt-24 pb-16">
      ...
      >
        <div className="container">
          ...
          >
            Explore our portfolio of exceptional custom homes, barndominiums, and renovations throughout Beaufort
      ...
      <Dialog open={!!selectedProject} onOpenChange={(open) => !open && setSelectedProject(null)}>
        <DialogContent className="max-w-3xl">
          {selectedProject && (
            <>
              <DialogHeader>
                <DialogTitle className="text-xl md:text-2xl font-helvetica">{selectedProject.title}</DialogTitle>
                <DialogDescription>
...
function ProjectCard({
  ...
  return (
    <motion.div ref={ref} variants={variants} className="group">
      <HoverCard>
