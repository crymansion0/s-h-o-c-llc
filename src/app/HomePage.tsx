  ...
  return (
    <section className="py-20 md:py-32 bg-muted">
      <div className="container">
        ...
        >
          <div className="inline-block bg-primary/60 px-4 py-2 rounded-lg mb-4">
            <h2 className="text-white font-medium text-sm uppercase tracking-wider">Testimonials</h2>
          </div>
          <h2 className="text-3xl md:text-5xl font-helvetica font-bold mb-6">What Our Clients Say</h2>
        </motion.div>
        <div>
    ...
    <section className="py-20 md:py-32 bg-primary text-white">
      <div className="container">
        <motion.div
          ...
          className="text-center mb-16"
        >
          <h2 className="text-3xl md:text-5xl font-helvetica font-bold mb-6">Ready to Build Your Dream Home?</h2>
          <p className="text-xl md:text-2xl">Contact us today to start the journey.</p>
          <Button size="lg" asChild className="mt-8 bg-background text-primary hover:bg-background/90 text-lg">
            <Link href="/contact">Contact Us</Link>
          </Button>
        </motion.div>
      </div>
