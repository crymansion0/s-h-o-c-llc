...
const projectsData = [
  ...
  },
  {
    ...
    category: "custom-homes",
    description: "Contemporary family home featuring open floor plan and energy-efficient design.",
    imageUrl: "/placeholder.jpg",
    completed: "2022",
    location: "Beaufort County, SC",
  },
  {
    ...
    category: "custom-homes",
    description: "Beach-inspired custom home with wraparound porch and natural materials.",
    imageUrl: "/placeholder.jpg",
    completed: "2023",
    location: "Beaufort County, SC",
  },
  {
    id: 4,
    title: "Traditional Southern Home",
    category: "custom-homes",
    description: "Classic Southern architecture with modern amenities and custom details.",
    imageUrl: "/placeholder.jpg",
    completed: "2022",
    location: "Beaufort County, SC",
  },
  {
    id: 5,
    title: "Rustic Barndominium",
    category: "barndominiums",
    description: "Spacious barndominium with rustic finishes and open concept living space.",
    imageUrl: "/placeholder.jpg",
    completed: "2023",
    location: "Beaufort County, SC",
  },
  {
    id: 6,
    title: "Modern Farmhouse Barndominium",
    category: "barndominiums",
    description: "Contemporary barndominium featuring farmhouse design elements and custom metal work.",
    imageUrl: "/placeholder.jpg",
    completed: "2022",
    location: "Beaufort County, SC",
  },
  {
    ...
    description: "Complete bathroom transformation with marble tile, soaking tub, and custom vanity.",
    imageUrl: "/placeholder.jpg",
    completed: "2023",
    location: "Beaufort County, SC",
  },
  {
    ...
    category: "renovations",
    description: "High-end kitchen renovation with custom cabinetry, quartz countertops, and professional appliances.",
    imageUrl: "/placeholder.jpg",
    completed: "2022",
    location: "Beaufort County, SC",
  },
  {
    ...
    category: "renovations",
    description: "Comprehensive renovation of 1980s residence with updated layout and modern finishes.",
    imageUrl: "/placeholder.jpg",
    completed: "2023",
    location: "Beaufort County, SC",
  },
  {
    id: 10,
    title: "Barndominium with Workshop",
    category: "barndominiums",
    description: "Custom barndominium featuring spacious living quarters and attached workshop area.",
    imageUrl: "/placeholder.jpg",
    completed: "2022",
    location: "Beaufort County, SC",
  },
  {
    ...
    category: "renovations",
    description: "Renovation project creating seamless transition between indoor and outdoor living areas.",
    imageUrl: "/placeholder.jpg",
    completed: "2023",
    location: "Beaufort County, SC",
  },
  {
    id: 12,
    title: "Multi-Family Barndominium",
    category: "barndominiums",
    description: "Innovative barndominium design accommodating multi-generational family living with separate spaces.",
    imageUrl: "/placeholder.jpg",
    completed: "2022",
    location: "Beaufort County, SC",
  },
